...
{ 
	...
	$getCustomerName = "SELECT distinct kitchenstaff_lastname FROM kitchenstaff WHERE kitchenstaff_id='$inputUserIDResult' AND password='$inputPasswordResult'";
...
if ($error OR count($_POST) == 0)
  ...
  <table>
    <tr><td>  
 <b><font size = "5">	*UserID: <input type="text" name="inputUserID" size="30" maxlength="30" value="$UserID" /><br />
	*Password: <input type="password" name="inputPassword" size="20" maxlength="20" value="$Password" /><br /><b></font>
    <i>*Required field</i>
    </td></tr>
  </table>
  <p><input type="submit" name="Submit" value="Check and Validate Infos" class = "button5" /></p>
</form>
EOT;
// ****************************************************************************
// End of form input
...
<?php
	if($showLogIn == false)
		...
		echo "<input type=\"submit\" name=\"Submit\" value=\"Log In\" class = \"button2\" />";
?>
...
<br><br>
<input type="button" value="Back" onClick="history.go(-1)" class = "button2">
