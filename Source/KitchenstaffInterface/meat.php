...
<div style="padding-left: 40%"><h>Meat</h><br></div>
<div>
...
<?php
	...
	echo "<div id=\"right-sidebar1\"><br>
       <div style = \"padding-left:10%\"><input type=\"button\" name = \"Back\" value = \"Go Back\" onclick = \"history.go(-1);\" class = \"button3\"/></div><br>
	<div style = \"padding-left:10%\"><input type=\"submit\" name = \"Submit\" value = \"Update\" class = \"button3\"/></div><br>";
?>
</form>

<!--Change action back to your directory-->
<form method="post" action="http://students.cse.unt.edu/~ss0789/kitchen/veggie.php">
<?php
	if($showLogIn == false)
		echo "<input type=\"submit\" name=\"Confirm Update\" value=\"Confirm Update\"  style=\"display:none;\" />";
	else if($showLogIn == true)
//		echo "<div id=\"right-sidebar1\"><br><br><br><br><br><br><br><br><br><br>
		echo "<div style = \"padding-left:10%\"><input type=\"submit\" name = \"Confirm Update\" value = \"Confirm Update\" class = \"button3\"/></div>
		</div>";
