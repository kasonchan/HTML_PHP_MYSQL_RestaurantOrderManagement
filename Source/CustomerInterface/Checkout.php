...
<div class=PageContainer>
	...
	<div class=FunctionsNavigation>
		...
		<form action="News.php">
			<input class=Button type="submit" value="News" /><BR>
		</form>
	...
	<div class=ContentContainer>
		<iframe class=frame src="http://students.cse.unt.edu/~kc0284/CustomerInterface/CheckoutMain.php" scrolling="auto"> </iframe>
	</div>
