...
if ($error OR count($_POST) == 0)
  ...
  <table>
    <tr><td>  
 	*UserID: <input type="text" name="inputUserID" class="textbox" size="30" maxlength="30" value="$UserID" /><br />
	*Password: <input type="password" name="inputPassword" class="textbox" size="20" maxlength="20" value="$Password" /><br />
    <i>*Required field</i>
    </td></tr>
  </table>
  <p><input type="submit" name="Submit" class="button1" value="Check and Validate Infos" /></p>
</form>
...
<form method="post" action="wait-staffLogInConfirmation.php">
<?php
	if($showLogIn == false)
...
?>
      ...
      <input type="text" name="inputUserID" value="<?=$UserID; ?>" />
</form>
